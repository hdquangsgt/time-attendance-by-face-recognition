...
class Dashboard(object):
    def __init__(self, root):
        ...
        Dashboard_Frame = Frame(Layout_Frame, bd=4, relief = RIDGE, bg = 'gray')
        ...
        btn_employee.grid(row = 0, column = 0, padx = 15, pady = 10)
        ...
        btn_keeptime.grid(row = 0, column = 1, padx = 15, pady = 15)
